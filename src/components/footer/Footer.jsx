    ...
    <footer className="footer__main">
      <div className="footer_container ">
        ...
        <div className="footer_subdiv footer_bold">
          <a className="footer_sub-item" href="/news/">
            NEWS
          </a>
          <a className="footer_sub-item" href="/news/politics">
            POLITICS
          </a>
          <a className="footer_sub-item" href="/entertainment/">
            ENTERTAINMENT
          </a>
          <a className="footer_sub-item" href="/life/">
            LIFE
          </a>
        </div>
        <div className="footer_subdiv footer_bold">
